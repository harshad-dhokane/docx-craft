  ...
  const steps = [
    {
      ...
      description: "Start by uploading a Word document (.docx) that will serve as your template.",
      details: [
    ...
    },
    {
      ...
      description: "Use double curly braces to mark fields that will be replaced with dynamic content.",
      details: [
    ...
    },
    {
      ...
      description: "Fill in the placeholder values and generate your customized PDF documents.",
      details: [
        "Click 'Generate PDF' on any template",
    ...
    },
    {
      ...
      description: "Access and download all your generated PDFs from the Generated PDFs page.",
      details: [
  ...
  const tips = [
    {
      ...
      items: [
        ...
        "Use consistent formatting in your Word documents"
      ]
    },
    {
      title: "Supported Formats",
      items: [
        "Input: Microsoft Word (.docx) files only",
    ...
    },
    {
      title: "Common Issues",
      items: [
        "Ensure placeholders use double curly braces: {{name}}",
        "Check that your .docx file isn't corrupted",
